...
export const cases = [
  ...
  {
    index: '02',
    href: '/work/exact-path',
    title: 'Exact Path',
    claim:
      'A student experience designed in about a month for a product that did not exist yet. It is still shipping a decade later, which says as much about the industry as it does about the design.',
    proves: 'Ten years in production',
  },
  {
    index: '03',
